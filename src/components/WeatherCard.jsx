    ...
    <article className='weathercard'>
      ...
      <div className='weathercard__data'>
        ...
        <div className='weathercard__temp'>
          <span className='temp'>{tempTranslator(data.main.temp, units).value.toFixed(1)}</span>
          <span className='tempunit'>{tempTranslator(data.main.temp, units).unit}</span>
        </div>
        <div className='weathercard__wind'>
          <div className='weathercard__wind-speed'>
            <span className='speed'>{speedTranslator(data.wind.speed, units).value.toFixed(1)}</span>
            <span className='windunit'>{speedTranslator(data.wind.speed, units).unit}</span>
          </div>
